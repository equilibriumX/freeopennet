 ...
 *   Copyright 2019 by Barnak Zlatko <equilibrium@barnak.co.rs>            *
 *                                                                         *
...
ColumnLayout {
    RowLayout{
        ...
        PlasmaComponents.TextField{
            ...
            onAccepted: {
                var url = text;
                if (url.indexOf(":/") < 0) {
                    url = "https://freeopen.net/index.php/component/search/?searchword=" + url;
                }
                webview.url = url;
            }
    ...
    Item {
        ...
        Layout.preferredWidth: units.gridUnit * 70
        Layout.preferredHeight: units.gridUnit * 35
